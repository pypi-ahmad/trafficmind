...
from apps.api.app.api.routes import access, alerts, analytics, cameras, events, exports, health, jobs, model_registry, observability, plates, signals, violations, watchlist
